...
var { port, db, cookieSecret } = require("./config/config"); // Application config properties
var { elementIsDisabled } = require("selenium-webdriver/lib/until");
/*
...
MongoClient.connect(config.db, function (err, db) {
        ...
        console.log(`Connected to the database` + congif.db);
